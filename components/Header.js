...
function Header() {
  ...
  return (
      ...
      <div className="sm:flex flex-grow cursor-pointer items-center rounded-md h-10 hidden bg-yellow-400 hover:bg-yellow-500">
          <input className="px-4 focus:outline-none p-2 h-full w-6 flex-grow rounded-l-md flex-shrink" type="text" />
          <SearchIcon className="h-12 p-4 "/>
      </div>

      <div className="text-white mx-6 whitespace-nowrap text-xs space-x-6 flex items-center"> 
     ...
     <div className=" text-white space-x-3 p-2 pl-6 text-sm flex items-center bg-amazon_blue-light">
         ...
         <p className="link">Today's Deels</p>
         <p className="hidden link lg:inline-flex ">Electronics</p>
         <p className="hidden link lg:inline-flex">Food & Grocery</p>
         <p className="hidden link lg:inline-flex">Price</p>
